...
const _RAW_PAGES: AlternativePage[] = [
  ...
  // === Knowledge Management ===
  {
    ...
    title: 'Docmost Alternatives: 5 Free Self-Hosted Wikis Compared (2026)',
    h1: '5 Free Self-Hosted Docmost Alternatives (2026)',
    description: 'BookStack vs Wiki.js vs Outline vs XWiki vs Affine — side-by-side comparison with Docker commands, migration guide, and license breakdown. Find the best Docmost replacement for your team.',
