...
const _RAW_PAGES: AlternativePage[] = [
  ...
  // === Knowledge Management ===
  {
    ...
    title: 'Docmost Alternatives 2026: 5 Self-Hosted Wikis (RAM & Docker)',
    h1: 'Docmost Alternatives — Interactive Comparison with Docker & RAM Specs',
    description: 'Best Docmost alternatives with RAM specs & Docker one-liners: BookStack (256MB), Wiki.js, Outline, XWiki, Affine. License & difficulty compared — pick in 60s.',
