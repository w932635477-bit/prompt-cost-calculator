...
const _RAW_PAGES: AlternativePage[] = [
  ...
  // === Knowledge Management ===
  {
    ...
    title: 'Best Docmost Alternatives for Self-Hosted Wikis [2026]',
    h1: 'Best Docmost Alternatives for Self-Hosted Wikis',
    description: 'Looking for Docmost alternatives? Compare BookStack, Wiki.js, and Outline — 3 open source self-hosted wiki tools with Docker quick-start, feature comparison, and migration guide.',
