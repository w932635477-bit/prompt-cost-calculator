...
const _RAW_PAGES: AlternativePage[] = [
  ...
  // === Knowledge Management ===
  {
    ...
    keywords: ['docmost alternative', 'docmost alternatives', 'docmost vs bookstack', 'docmost vs outline', 'docmost vs affine', 'best self-hosted wiki 2026', 'docmost open source alternative', 'self-hosted documentation tool', 'best docmost alternative', 'docmost competitors', 'docmost vs wiki.js', 'self-hosted wiki comparison', 'docmost vs xwiki', 'docmost production ready', 'docmost replacement'],
    quickDecision: [
