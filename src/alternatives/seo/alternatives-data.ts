...
const _RAW_PAGES: AlternativePage[] = [
  ...
  // === Knowledge Management ===
  {
    ...
    description: 'Looking for a Docmost alternative? Compare the 4 best open-source self-hosted wikis — BookStack, Wiki.js, Outline, and XWiki — with Docker commands, feature tables, and a migration guide. Find the right Docmost replacement for your team.',
    explanation: 'Docmost is a rising open source wiki with a Notion-like block editor (3K+ GitHub stars, launched 2024). It offers real-time collaboration and a modern interface, but it\'s still a young project with fewer integrations and a smaller plugin ecosystem. BookStack (15K+ GitHub stars, MIT license) offers a simpler book/chapter/page hierarchy with 10+ years of stable development. Wiki.js adds Git-backed storage and enterprise auth. Outline provides the most polished Notion-like experience with Slack integration. XWiki brings enterprise features like structured data forms and a scripting API, trusted by organizations like NASA and SAP for 20+ years.',
    faq: [
      ...
      { q: 'Which Docmost alternative is easiest to self-host?', a: 'BookStack is the easiest — one Docker command and you\'re running. It needs minimal resources (works on a $5/month VPS). Wiki.js and Outline require external databases (PostgreSQL). XWiki needs the most resources but offers the most enterprise features.' },
    ],
    keywords: ['docmost alternative', 'docmost alternatives', 'docmost vs bookstack', 'docmost vs outline', 'best self-hosted wiki 2026', 'docmost open source alternative', 'self-hosted documentation tool', 'best docmost alternative', 'docmost competitors', 'docmost vs wiki.js', 'self-hosted wiki comparison', 'docmost vs xwiki', 'docmost production ready', 'docmost replacement'],
  },
  {
    slug: 'obsidian',
    saasName: 'Obsidian',
