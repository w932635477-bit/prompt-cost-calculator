...
const _RAW_PAGES: AlternativePage[] = [
  ...
  // === Knowledge Management ===
  {
    ...
    title: 'Best Docmost Alternatives 2026 — 5 Free Self-Hosted Wikis (Docker Ready)',
    h1: '5 Free Self-Hosted Docmost Alternatives (2026)',
    description: 'Top 5 Docmost alternatives: BookStack, Wiki.js, Outline, XWiki, Affine. Feature comparison table, Docker one-liners, and migration guide. All free and open source.',
