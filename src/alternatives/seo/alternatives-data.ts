...
const _RAW_PAGES: AlternativePage[] = [
  ...
  // === Knowledge Management ===
  {
    ...
    h1: 'Docmost Alternatives — Best Self-Hosted Wiki Tools (2026)',
    description: 'Looking for a Docmost alternative? Compare the 5 best open-source self-hosted wikis — BookStack, Wiki.js, Outline, XWiki, and Affine — with Docker commands, feature tables, and a migration guide.',
