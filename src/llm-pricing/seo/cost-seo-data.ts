...
export const COST_SEO_PAGES: CostSeoPage[] = [
  {
    ...
    faq: [
      ...
      { q: 'How do I convert my usage from characters to tokens?', a: 'In English, roughly 4 characters equal 1 token. A 1,000-word document is about 1,300 tokens. Code and non-English text tokenize differently — use the token counter on this site for precise counts before plugging numbers into the cost calculator.' },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'Should I switch providers to save money?', a: 'Not necessarily. Switching costs include migration effort, latency differences, and potential accuracy changes. First optimize within your current provider using caching and model routing. Only switch if the savings exceed migration costs — typically when you spend over $500/month.' },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'What is the biggest hidden cost in LLM APIs?', a: 'Output tokens. They cost 3-6x more than input tokens but many teams focus only on input pricing. A model with cheap input but expensive output can cost more in practice than a balanced model. Always calculate total cost including both input and output for your actual usage pattern.' },
    ],
