// src/finder/chat/RecommendationCard.tsx
    ...
    <article className="bg-white rounded-2xl shadow-sm overflow-hidden" data-testid={`rec-card-${rec.rank}`}>
      ...
      <div className="p-5 md:p-6 border-b border-[#e8e8ed]">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 mt-4 text-sm">
          ...
          <div className="bg-[#f5f5f7] rounded-xl p-2.5">
            <div className="text-[10px] text-[#86868b] mb-0.5 uppercase tracking-wide">Deploy</div>
            <div className="font-medium text-[#1d1d1f]">
              {t.tags.includes('docker_easy') ? 'Docker' : t.tags.includes('single_binary') ? 'Binary' : 'Self-host'}
            </div>
          </div>
        </div>
      </div>
