  ...
  build: {
    rollupOptions: {
      input: {
        ...
        'testing-strategy': resolve(__dirname, 'testing-strategy-picker/index.html'),
        'testing-strategy-web-app': resolve(__dirname, 'testing-strategy-picker/web-app/index.html'),
        'testing-strategy-api': resolve(__dirname, 'testing-strategy-picker/api/index.html'),
        'testing-strategy-mobile': resolve(__dirname, 'testing-strategy-picker/mobile/index.html'),
        'pricing-comparison': resolve(__dirname, 'llm-pricing/compare-all/index.html'),
        'alternatives-guide': resolve(__dirname, 'alternatives-guide/index.html'),
        'ai-api-costs-guide': resolve(__dirname, 'guides/ai-api-costs/index.html'),
        ...localeInputs,
        ...longTailInputs,
        ...altInputs,
        ...deployInputs,
